...
ngram-count -text $sdir/cleaned.train -order 3 -limit-vocab -vocab $sdir/wordlist.final.s -unk \
  -map-unk "<SPN>" -kndiscount -interpolate -lm $sdir/srilm.o3g.kn.gz
...
ngram-count -text $sdir/cleaned.train -order 4 -limit-vocab -vocab $sdir/wordlist.final.s -unk \
  -map-unk "<SPN>" -kndiscount -interpolate -lm $sdir/srilm.o4g.kn.gz
...
#3-gram with pruning:
ngram-count -text $sdir/cleaned.train -order 3 -limit-vocab -vocab $sdir/wordlist.final.s -unk \
  -prune 0.0000001 -map-unk "<SPN>" -kndiscount -interpolate -lm $sdir/srilm.o3g.pr7.kn.gz
